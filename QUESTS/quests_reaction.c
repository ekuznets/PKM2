...
void QuestComplete(string sQuestName)
{
	...
	switch(sQuestName)
	{
		case "begining":
			...
			pchar.quest.becomes_oldman.win_condition.l1.date.year = 1631;
		...
		case "Story_leavingOxbay":
			...
			Character_SetAbordageEnable(characterFromID("Remy Gatien"), true);
			Character_SetAbordageEnable(characterFromID("Yves Giner"), true);
			Character_SetAbordageEnable(characterFromID("Begon Monchaty"), true);
