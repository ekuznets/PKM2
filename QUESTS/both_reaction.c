...
//Tutorial
		...
		case "Tut_start":
			...
			//KE: Malcolm Hatcher can not undead
		...
		case "Tut_KillTutor":
			...
			Pchar.quest.Tut_RewardForKillingTutor.win_condition.l1.value = 1;
			...
			pchar.quest.Tut_RewardForKillingTutor.win_condition.l2.location = "Dungeon 1";
		...
		case "Tut_FirstMeleeFight":
			...
			LAi_SetHP(CharacterFromID("Malcolm Hatcher"), 200.0, 200.0);
			Lai_SetCheckMinHP(CharacterFromID("Malcolm Hatcher"), 100.0, true, "Tut_NowFightWithMight");
		break;
		...
		case "Tut_StartSeriousFight":
			...
			Lai_SetCheckMinHP(Pchar, 100.0, false, "SeriousFightFinished");
			Lai_SetCheckMinHP(CharacterFromID("Malcolm Hatcher"), 100.0, true, "SeriousFightFinished");
		...
		case "Tut_StartSeriousFightAgain":
			...
			Lai_SetCheckMinHP(Pchar, 100.0, false, "SeriousFightFinishedAgain");
			Lai_SetCheckMinHP(CharacterFromID("Malcolm Hatcher"), 100.0, true, "SeriousFightFinishedAgain");
