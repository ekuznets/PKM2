...
void InitInterface(string iniName)
{
	...
	CreateString(true,"Available","",FONT_NORMAL,COLOR_NORMAL,400,233,SCRIPT_ALIGN_LEFT,1.0);
    CreateString(false,"Cost","",FONT_NORMAL,COLOR_NORMAL,320,299,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(false,"BuyMorale",XI_ConvertString(GetMoraleName(nCrewMorale)),FONT_NORMAL,COLOR_NORMAL,320,321,SCRIPT_ALIGN_LEFT,1.0);
