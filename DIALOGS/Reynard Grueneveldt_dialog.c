...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "kill_pirate":
			GeneratePirateQuest("Douwesen");
			dialog.text = DLG_TEXT[24] + characters[GetCharacterIndex(DLG_TEXT[25])].ship.name + DLG_TEXT[26] + pchar.quest.killdestination + DLG_TEXT[27] + pchar.quest.killmoney + DLG_TEXT[28];
			link.l1 = DLG_TEXT[29];
