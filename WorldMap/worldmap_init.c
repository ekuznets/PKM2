...
/*	SetEventHandler("WorldMap_EncounterCreate", "wdmEvent_EncounterCreate", 0);
	...
	*/
	...
	//Island label
	worldMap.islands.FaleDeFler.label.text = "Фале де Флер";
	...
	worldMap.islands.FaleDeFler.locations.city.move = "false";
	//Label
	worldMap.islands.FaleDeFler.locations.city.label.text = "Фале де Флер";
	...
	worldMap.islands.FaleDeFler.locations.city1.move = "false";
	//Label
	worldMap.islands.FaleDeFler.locations.city1.label.text = "Залив Осьминога";
	...
	//Island label
	worldMap.islands.Redmond.label.text = "Редмонд";
	...
	//Label
	worldMap.islands.Redmond.locations.city.label.text = "Редмонд";
	...
	//Label
	worldMap.islands.Redmond.locations.city1.label.text = "Глотка дьявола";
	...
	//Label
	worldMap.islands.Redmond.locations.city2.label.text = "Скалистый берег";
	...
	//Island label
	worldMap.islands.Oxbay.label.text = "Оксбей";
	...
	//Label
	worldMap.islands.Oxbay.locations.city.label.text = "Оксбей";
	...
	//Label
	worldMap.islands.Oxbay.locations.city1.label.text = "Залив серой скалы";
	...
	//Label
	worldMap.islands.Oxbay.locations.city4.label.text = "Дальняя бухта";
	...
	//Label
	worldMap.islands.Oxbay.locations.city2.label.text = "Маяк";
	...
	//Label
	worldMap.islands.Oxbay.locations.city3.label.text = "Гринфорд";
	...
	//Island label
	worldMap.islands.Douwesen.label.text = "Дувезен";
	...
	//Label
	worldMap.islands.Douwesen.locations.city.label.text = "Дувезен";
	...
	//Label
	worldMap.islands.Douwesen.locations.city1.label.text = "Пальмовый берег";
	...
	//Label
	worldMap.islands.Douwesen.locations.city2.label.text = "Крабовый утес";
	...
	//Island label
	worldMap.islands.Conceicao.label.text = "Консейсао";
	...
	//Label
	worldMap.islands.Conceicao.locations.city.label.text = "Солнечная бухта";
	...
	//Label
	worldMap.islands.Conceicao.locations.city1.label.text = "Консейсао";
	...
	//Label
	worldMap.islands.Conceicao.locations.city2.label.text = "Скала Левиафана";
	...
	//Island label
	worldMap.islands.IslaMuelle.label.text = "Исла Муэлье";
	...
	//Label
	worldMap.islands.IslaMuelle.locations.city.label.text = "Исла Муэлье";
	...
	//Label
	worldMap.islands.IslaMuelle.locations.city1.label.text = "Берег";
	...
	//Label
	worldMap.islands.IslaMuelle.locations.city2.label.text = "Устричный пляж";
	...
	//Island label
	worldMap.islands.QuebradasCostillas.label.text = "Кебрадас Костиллас";
	...
	//Label
	worldMap.islands.QuebradasCostillas.locations.city.label.text = "Пиратский порт";
	...
	//Island label
	worldMap.islands.KhaelRoa.label.text = "Каэль Роа";
	...
	//Label
	worldMap.islands.KhaelRoa.locations.city.label.text = "Каэль Роа";
