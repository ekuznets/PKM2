...
#define FRA_COLONY 		"Фале де Флер"
#define SPA_COLONY 		"Исла Муэлье"
#define POR_COLONY 		"Консейсао"
#define HOL_COLONY 		"Дувезен"
#define RED_COLONY 		"Редмонд"
#define OX_COLONY 		"Оксбэй"
#define GREEN_COLONY 	"Гринфорд"

#define OFFIC_TYPE_BOATSWAIN	 "боцман"
#define OFFIC_TYPE_CANNONEER	 "канонир"
#define OFFIC_TYPE_QMASTER	 "квартирмейстер"
#define OFFIC_TYPE_NAVIGATOR	 "навигатор"
#define OFFIC_TYPE_FIRSTMATE	 "первый помощник"
...
{ 
	...
	{	
		case "Blaze":
			...
			Address_Form.Spa = "Сеньер";
			Address_Form.Fra = "Мисье";
			Address_Form.Eng = "Сэр";
			Address_Form.Por = "Сеньер";
			Address_Form.Hol = "Сир";
			return;
		break;

		case "Danielle":

			Address_Form.Spa = "Сеньерита";
			Address_Form.Fra = "Мадемуазель";
			Address_Form.Eng = "Мисс";
			Address_Form.Por = "Сеньерита";
			Address_Form.Hol = "Сеньерита";
			return;
		break;
	}
