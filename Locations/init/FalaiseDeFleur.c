int LocationInitFalaiseDeFleur(int n)
{
	...
	locations[n].id.label = "Порт Фале де Флер";
	...
	locations[n].id.label = "Пляж Фале де Флер";
	locations[n].worldmap = "Falaise De Fleur";
...
/*	Locations[n].reload.l3.name = "sea";
	...
	locations[n].id.label = "Фале де Флер";
	locations[n].worldmap = "Falaise De Fleur";
	...
	locations[n].id.label = "Церковь Фале де Флер";
...
//	Locations[n].models.night.lamp = "FalaiseDeFleur05_night";
	...
	locations[n].id.label = "Джунгли Фале де Флер";
...
//	locations[n].fastreload = "Falaise_De_Fleur";
	...
	locations[n].id.label = "Берег Фале де Флер";
	...
	locations[n].id.label = "Резиденция Фале де Флер";
	...
	locations[n].id.label = "Таверна Фале де Флер";
	...
	locations[n].id.label = "Комната в таверне Фале де Флер";
	Locations[n].filespath.models = "locations\inside\Doubleflour_house";
	...
	locations[n].id.label = "Верфь Фале де Флер";
	...
	locations[n].id.label = "Магазин Фале де Флер";
	...
	locations[n].id.label = "Дом в Фале де Флер";
	Locations[n].filespath.models = "locations\inside\DoubleFlour_house\";
	Locations[n].image = "loading\house_08.tga";
	...
	locations[n].id.label = "Дом главы порта";
	//Sound
	Locations[n].filespath.models = "locations\inside\mh5";
	Locations[n].image = "loading\house_06.tga";
