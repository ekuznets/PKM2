...
int LocationInitQuestLocations(int n)
{
	...
	locations[n].id.label = "Порт Грнифорда";
	//Sound
...
//---------------------------------------------------------------------------
	...
	locations[n].id.label = "Пиратский барк";
	//Sound
	...
	locations[n].id.label = "Кормабль Гамбоа";
	//Sound
	Locations[n].models.always.locators = "qdeck_l";
	Locations[n].models.always.l1 = "qdeck";
	//Day
	...
	locations[n].id.label = "Похитители' убежище, 2ой этаж";
	Locations[n].filespath.models = "Locations\Inside\Doubleflour_house";
...
//Hitman
	...
	Locations[n].id.label = "Дом Матеуса Сантоса";
	Locations[n].filespath.models = "Locations\Inside\Doubleflour_house";
...
/*	Locations[n].models.always.window = "LH_F2_w";
	...
	locations[n].id.label = "Дом Джеффри Бэмпфилда";
...
/*	Locations[n].models.always.window = "MH_w";
	...
	Locations[n].id.label = "Дом Америго Виейра";
	Locations[n].filespath.models = "Locations\Inside\Doubleflour_house";
...
//Hitman
	...
	Locations[n].id.label = "Каюта капитана";
