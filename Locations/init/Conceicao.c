...
int LocationInitConceicao(int n)
{
	...
	locations[n].id.label = "Консейсао";
	...
	locations[n].id.label = "Город Консейсао";
	locations[n].worldmap = "Conceicao";
	...
	locations[n].id.label = "Резиденция Консейсао";
	...
	locations[n].id.label = "Выход из Консейсао";
...
//	locations[n].fastreload = "Conceicao";
	...
	locations[n].id.label = "Магазин Консейсао";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Верфь Консейсао";
	...
	locations[n].id.label = "Таверна Консейсао";
	...
	locations[n].id.label = "Комната в таверне Консейсао";
	...
	locations[n].id.label = "Джунгли Консейсао";
	...
	locations[n].id.label = "Берег Консейсао";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Выход из логова контрабандистов";
	...
	locations[n].id.label = "Логово контрабандистов";
	...
	locations[n].id.label = "Таверна контрабандистов";
	...
	locations[n].id.label = "Дом лидера контрабандистов";
	...
	locations[n].id.label = "Дом Реймса в логове контрабандистов";
	Locations[n].image = "loading\room.tga";
	//Sound
	locations[n].type = "house";
	...
	locations[n].id.label = "Комната в таверне логова контрабандистов";
	Locations[n].image = "loading\Tavern_Upstairs_01.tga";
	//Sound
	locations[n].type = "house";
	...
	locations[n].id.label = "Церковь Консейсао";
...
//-------------------------------------------------------------------------------------------
	...
	locations[n].id.label = "Спрятанная пещера";
