...
/*	Locations[n].reload.l7.name = "door_5";
	...
	locations[n].id.label = "Порт Редмонда";
	locations[n].worldmap = "Redmond";
	...
	locations[n].id.label = "Выход из Редмонда";
...
/*	Locations[n].reload.l2.name = "reload1";
  ...
  // -------------------------------------------------
	...
	locations[n].id.label = "Берег Редмонда";
...
/*	Locations[n].models.always.l1 = "plan_1";
	...
	locations[n].id.label = "Джунгли Редмонда";
...
//	Locations[n].models.night.fonar = "jungle01_fn";
	...
	locations[n].id.label = "Таверна Редмонда";
	...
	locations[n].id.label = "Комната в таверне Редмонда";
	...
	locations[n].id.label = "Магазин Редмонда";
	...
	locations[n].id.label = "Верфь Редмонда";
	...
	locations[n].id.label = "Резиденция Редмонда";
	...
	locations[n].id.label = "Тюрьма Редмонда";
	...
	locations[n].id.label = "Церковь Редмонда";
