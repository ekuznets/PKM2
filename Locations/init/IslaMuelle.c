...
int LocationInitIslaMuelle(int n)
{
	...
	locations[n].id.label = "Порт Исла Муэлле";
	...
	locations[n].id.label = "Исла Муэлле";
	locations[n].worldmap = "Isla Muelle";
	...
	locations[n].id.label = "Верфь Исла Муэлле";
	...
	locations[n].id.label = "Магазин Исла Муэлле";
	...
	locations[n].id.label = "Таверна Исла Муэлле";
	...
	locations[n].id.label = "Комната в таверне Исла Муэлле";
	...
	locations[n].id.label = "Резиденция Исла Муэлле";
	...
	locations[n].id.label = "Дом на Исла Муэлле";
	...
	locations[n].id.label = "Выход из Исла Муэлле";
...
//	locations[n].fastreload = "Muelle";
	...
	locations[n].id.label = "Проход Исла Муэлле";
...
//	Locations[n].locators_radius.reload.reload1 = 2.0;
	...
	locations[n].id.label = "Берег Исла Муэлле";
	...
	locations[n].id.label = "Дом в Исла Муэлле";
	Locations[n].image = "loading\House_08.tga";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Вход пещер Исла Муэлле";
	...
	locations[n].id.label = "Логово язычников";
	...
	locations[n].id.label = "Церковь Исла Муэлле";
