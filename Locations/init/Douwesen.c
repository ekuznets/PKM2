...
int LocationInitDouwesen(int n)
{
	...
	locations[n].id.label = "Порт Дувезена";
	...
	locations[n].id.label = "Город Дувезена";
...
//	Locations[n].reload.l10.close_for_night = 1;
	...
	locations[n].id.label = "Резиденция Дувезена";
	...
	locations[n].id.label = "Выход из Дувезена";
...
//	locations[n].fastreload = "Douwesen";
	...
	locations[n].id.label = "Верфь Дувезена";
	...
	locations[n].id.label = "Магазин Дувезена";
	...
	locations[n].id.label = "Таверна Дувезена";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Комната в таверне Дувезена";
...
//	Locations[n].models.night.fonar = "LH_F1_fn";
	...
	locations[n].id.label = "Пиратский форт";
	...
	locations[n].id.label = "Дом лидера пиратов Дувизена";
	Locations[n].image = "loading\room.tga";
	//Sound
	locations[n].type = "house";
	...
	*/
	...
	locations[n].id.label = "Джунгли Дувезена";
	...
	locations[n].id.label = "Берег Дувезена";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Дом в джунглях";
...
/*
	...
	locations[n].id.label = "Дом Реймса на Дувезене";
	Locations[n].image = "loading\room.tga";
	//Sound
	locations[n].type = "house";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Комната в пиратской таверне";
	Locations[n].image = "loading\Tavern_Upstairs_01.tga";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Пещера Дувезена";
