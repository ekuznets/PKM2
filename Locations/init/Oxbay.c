...
int LocationInitOxbay(int n)
{
	...
	locations[n].id.label = "Порт Оксбея";
	...
	locations[n].id.label = "Выход из Оксбея";
	...
	locations[n].id.label = "Верфь Оксбея";
	...
	locations[n].id.label = "Магазин Оксбея";
	...
	locations[n].id.label = "Таверна Оксбея";
	...
	locations[n].id.label = "Комната в таверне Оксбея";
	...
	locations[n].id.label = "Дом ростовщика";
	...
	locations[n].id.label = "Джунгли Оксбея";
	...
	locations[n].id.label = "Берег Оксбея";
	...
	locations[n].id.label = "Джунги Оксбея";
	...
	locations[n].id.label = "Вход в пещеру Оксбея";
...
//____________________________________________________// -------------------------------------------------
	...
	locations[n].id.label = "Порт Гринфорда";
...
//Hitman
	...
	locations[n].id.label = "Выход из Гринфорда";
	...
	locations[n].id.label = "Верфь Гринфорда";
	...
	locations[n].id.label = "Магазин Гринфорда";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Таверна гринфорда";
	...
	locations[n].id.label = "Комната в таверне Гринфорда";
	Locations[n].image = "loading\Tavern_Upstairs_01.tga";
	...
	locations[n].id.label = "Каньон Оксбея";
...
//	locations[n].fastreload = "Greenford";
	...
	locations[n].id.label = "Маяк Оксбея";
...
//	Locations[n].reload.l4.close_for_night = 1;
	...
	locations[n].id.label = "Внутри маяка";
	Locations[n].image = "loading\Oxbay_Lighthouse.tga";
	//Sound
	locations[n].type = "house";
...
// -------------------------------------------------
	...
	locations[n].id.label = "Шахты Оксбея";
...
/*	Locations[n].reload.l2.name = "reload1";
	...
	locations[n].id.label = "Тюрьма Гринфорда";
	...
	locations[n].id.label = "Церковь Гринфорда";
...
//	Locations[n].models.night.lamp = "FalaiseDeFleur05_night";
	...
	//KE: change monster generation to false
	// hope skeletons wont respawn all the time
	LAi_LocationFantomsGen(&locations[n], false);
