...
int LocationInitQuebradasCostillas(int n)
{
	...
	locations[n].id.label = "Порт Кебрадас Костиллас";
	...
	locations[n].id.label = "Кебрадас Костиллас";
	locations[n].worldmap = "Quebradas Costillas";
	//Town sack
	...
	locations[n].id.label = "Выход из Кебрадас Костиллас";
...
//	locations[n].fastreload = "QC";
	...
	locations[n].id.label = "Дом лидера пиратов";
	...
	locations[n].id.label = "Магазин Кебрадас Костиллас";
	//Town sack
	Locations[n].townsack = "Oxbay";
	//Sound
	...
	locations[n].id.label = "Таверна Кебрадас Костиллас";
	...
	locations[n].id.label = "Комната в таверне Кебрадас Костиллас";
	...
	locations[n].id.label = "Вход в чужой дом";
	...
	locations[n].id.label = "В чужом доме";
	Locations[n].image = "loading\room.tga";
	//Sound
	locations[n].type = "house";
	//Models
